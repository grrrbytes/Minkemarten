...
<html <?php language_attributes(); ?>> 
  <head>
    ...
    <link href='<?php bloginfo('template_directory'); ?>/css/<?php echo $body_class; ?>.css' rel='stylesheet' type='text/css' />
	...
	<link rel="alternate" type="application/rss+xml" title="Marten Minkema RSS feed" href="<?php bloginfo('rss2_url'); ?>" />
      ...
      <header id='hoofding'>
        <nav id='hoofdmenu'>
          <ul id='knoppen'>
            ...
            <li class='knop' id='links'>
              <a href='<?php bloginfo('url'); ?>/links' title=''></a>
            </li>
